...
import static gg.manny.hologram.util.DataWatcherHelper.CUSTOM_NAME;
import static gg.manny.hologram.util.DataWatcherHelper.CUSTOM_NAME_VISIBLE;
...
//        setVisible(true);
    ...
    public boolean setVisible(boolean visible) {
        if (this.visible != visible) {
            datawatcher.watch(CUSTOM_NAME_VISIBLE.getId(), (byte) (visible ? 1 : 0));
        }
        return visible;
    }
